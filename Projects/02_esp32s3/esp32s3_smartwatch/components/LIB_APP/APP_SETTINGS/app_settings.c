...
void settings_BuildSettingsScreen( lv_timer_t *pTimer )
{
    ...
    lv_obj_t *pExitBtn                                  = pUserSettingsObj->pSettingsExitBtn;
    ...
    COMMON_RegisterUserObj( pSettingsContainerObj, COMMON_eTypeDontTrack );
    ...
    lv_obj_set_style_bg_grad_color(pSettingsContainerObj, lv_color_make( 32, 43, 71 ), LV_PART_MAIN);
    ...
    // Create Exit button
    pExitBtn = lv_btn_create(pSettingsContainerObj);
